...
// import React, { useEffect, useState } from "react";
// import { Link, useLocation, useNavigate } from "react-router-dom";
// import { API_BASE_URL, CHURCH_INFO, HEADER_LOGO_IMAGE_URL } from "../config.js";
...
//   const navigate = useNavigate();
//   const [scrolled, setScrolled] = useState(variant !== "overlay");
//   const [logoUrl, setLogoUrl] = useState(HEADER_LOGO_IMAGE_URL || null);

//   useEffect(() => {
//     fetch(`${API_BASE_URL}/api/site-images/header_logo`)
...
//               className={`hc-wordmark-logo ${
//                 variant === "overlay" && !scrolled ? "hc-wordmark-logo--force-white" : ""
//               }`}
//             />
//           ) : (
//             CHURCH_INFO.name
